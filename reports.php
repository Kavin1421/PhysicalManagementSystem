...
<head>
 ...
 <title>Reports - Physical Management System in PHP</title>
    ...
    <section class="content">
      ...
      <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
          <h3 class="card-title">Players Visits Between Two Dates</h3>
...
<div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
          <h3 class="card-title">Event Based Report Between Two Dates</h3>
